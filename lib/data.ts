...
export const DEFAULT_MODULES: Module[] = [
    ...
    lessons: [
      {
        ...
        content: { sections: [
          ...
          { type: 'stat', title: 'Infografik: CIA Triad dalam Konteks Sekolah', text: '<div style=\'display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;margin:8px 0\'><div style=\'background:#eff6ff;border:1px solid #bfdbfe;border-radius:10px;padding:10px;text-align:center\'><div style=\'font-size:1.5rem\'>🔒</div><div style=\'font-weight:700;color:#1d4ed8;font-size:0.75rem\'>CONFIDENTIALITY</div><div style=\'font-size:0.65rem;color:#374151;margin-top:4px\'>Nilai rapor siswa hanya untuk wali kelas</div></div><div style=\'background:#f0fdf4;border:1px solid #bbf7d0;border-radius:10px;padding:10px;text-align:center\'><div style=\'font-size:1.5rem\'>✅</div><div style=\'font-weight:700;color:#15803d;font-size:0.75rem\'>INTEGRITY</div><div style=\'font-size:0.65rem;color:#374151;margin-top:4px\'>Nilai Dapodik tidak bisa diubah sembarang pihak</div></div><div style=\'background:#fff7ed;border:1px solid #fed7aa;border-radius:10px;padding:10px;text-align:center\'><div style=\'font-size:1.5rem\'>🌐</div><div style=\'font-weight:700;color:#c2410c;font-size:0.75rem\'>AVAILABILITY</div><div style=\'font-size:0.65rem;color:#374151;margin-top:4px\'>Portal presensi harus bisa diakses tiap hari kerja</div></div></div>' },
          { type: 'image', src: '/images/cia-triad.svg', alt: 'Diagram CIA Triad', caption: 'CIA Triad — Tiga Pilar Keamanan Informasi dalam Konteks Sekolah' },
      ...
      },
      {
        ...
        content: { sections: [
          ...
          { type: 'image', src: '/images/nist-csf.svg', alt: 'NIST Cybersecurity Framework 2.0', caption: 'NIST CSF 2.0 — 6 Fungsi Utama Keamanan Siber' },
  ...
  },
  {
    ...
    lessons: [
      ...
      {
        id: 'm2l1b', title: 'Apa itu Kata Sandi Kuat? Kriteria NIST', type: 'reading', emoji: '🔑', typeLabel: 'Membaca', dur: '5 mnt', xp: 50,
        content: { sections: [
          { type: 'intro', text: 'Tidak semua kata sandi diciptakan sama. NIST SP 800-63B — standar keamanan paling banyak digunakan dunia — mendefinisikan secara ilmiah apa yang membuat kata sandi benar-benar kuat.' },
          { type: 'case', title: 'Faktor Kekuatan Kata Sandi', text: '<strong>① Panjang (faktor terpenting)</strong><br>Setiap karakter tambahan melipatgandakan kombinasi yang harus ditebak peretas. Kata sandi 8 karakter bisa diretas dalam hitungan menit; 16 karakter membutuhkan miliaran tahun.<br><br><strong>② Keacakan / Entropi</strong><br>Frasa sandi acak seperti "singa-biru-makan-nasi" jauh lebih kuat dari "P@ssw0rd1!" meski tampak lebih sederhana — karena tidak mengikuti pola yang bisa diprediksi.<br><br><strong>③ Unik per Akun</strong><br>Menggunakan kata sandi yang sama di banyak akun = satu kebocoran membuka semua pintu.' },
          { type: 'image', src: '/images/password-strength.svg', alt: 'Perbandingan Kekuatan Kata Sandi', caption: 'Waktu yang dibutuhkan peretas untuk membobol kata sandi — semakin panjang semakin aman' },
          { type: 'warning', title: 'Mitos yang Harus Dibuang', text: '❌ <strong>"Kata sandi rumit (P@$$w0rd!) pasti kuat"</strong> — SALAH. Komputer menebak pola ini dalam detik.<br>❌ <strong>"Ganti kata sandi setiap bulan"</strong> — SALAH (NIST 2024). Sering ganti justru mendorong pilihan yang lebih lemah.<br>❌ <strong>"Kata sandi pendek tapi rumit lebih aman"</strong> — SALAH. "anjing-hitam-malam-ini" mengalahkan "X!9@kL2#".' },
          { type: 'tip', title: 'Rumus Kata Sandi Ideal (NIST)', text: '✓ <strong>Minimal 12 karakter</strong> — semakin panjang semakin baik<br>✓ <strong>Gunakan passphrase</strong>: 3–4 kata acak yang tidak berhubungan<br>✓ <strong>Satu kata sandi per akun</strong> — gunakan password manager<br>✓ <strong>Aktifkan MFA/2FA</strong> di semua akun penting sebagai lapisan kedua' },
        ]}
      },
      {
      ...
      },
      {
        ...
        content: { sections: [
          ...
          { type: 'image', src: '/images/phishing-anatomy.svg', alt: 'Anatomi Email Phishing', caption: 'Anatomi email phishing — kenali setiap ciri bahayanya sebelum Anda klik' },
      ...
      },
      {
        ...
        content: {
          instruction: 'Analisis setiap pesan berikut. Tentukan: Aman atau Tidak Aman? Perhatikan detail setiap elemen.',
          scenarios: [
            {
    ...
    lessons: [
      {
        ...
        content: { sections: [
          ...
          { type: 'image', src: '/images/social-media-privacy.svg', alt: 'Pengaturan Privasi Instagram dan WhatsApp', caption: 'Checklist pengaturan privasi wajib — selesaikan dalam 15 menit' },
      ...
      },
      {
        ...
        content: { sections: [
          ...
          { type: 'image', src: '/images/mobile-security.svg', alt: '5 Lapisan Keamanan HP', caption: '5 pengaturan keamanan HP yang wajib diaktifkan sekarang' },
    ...
    lessons: [
      {
        ...
        content: { sections: [
          ...
          { type: 'image', src: '/images/digital-footprint.svg', alt: 'Dua Jenis Jejak Digital', caption: 'Jejak aktif dibuat secara sadar; jejak pasif dikumpulkan diam-diam tanpa Anda tahu' },
      ...
      },
      {
        ...
        content: { sections: [
          ...
          { type: 'image', src: '/images/incident-response.svg', alt: '5 Langkah Respons Insiden Siber', caption: 'Ikuti urutan ini — jangan skip langkah manapun — untuk meminimalisir kerusakan' },
    ...
    lessons: [
      ...
      },
      {
        ...
        content: { sections: [
          ...
          { type: 'image', src: '/images/ransomware-stages.svg', alt: 'Cara Kerja Ransomware', caption: '4 tahap serangan ransomware — dari masuk hingga tuntutan tebusan' },
      ...
      },
      {
        ...
        content: { sections: [
          ...
          { type: 'image', src: '/images/backup-321.svg', alt: 'Strategi Backup 3-2-1', caption: '3 salinan · 2 jenis media · 1 lokasi offsite — standar emas perlindungan data' },
